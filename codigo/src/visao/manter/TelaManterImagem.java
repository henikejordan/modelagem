 ...
 * @author Henike
 */
public class TelaManterImagem extends javax.swing.JFrame {

    private static TelaManterImagem instance;
    private int id;
    ...
    public static TelaManterImagem getInstance() {
        if (instance == null) {
            instance = new TelaManterImagem();
        }
        return instance;
    }
